...
<!-- ── SPEAKERS ─────────────────────────────────────────── -->
 <section id="speakers">
    ...
    <div class="speakers-grid">
      ...
      <div class="speaker-card" onclick="showSpeakerModal('Dr. Aldrich Richard','Director of Silviculture and Forest Biology Conservation Division','Forestry Department of Peninsular Malaysia','{{ asset('images/talker/ALDRICH.png') }}','Dr. Aldrich Richard holds a PhD in Forest and Ecosystem Science from Universiti Putra Malaysia, as well as a Master of Science in Botany from the National University of Malaysia and a degree in Forestry Science from Universiti Putra Malaysia. He started his career in 2000 as the Assistant Director of Forestry (Amenity Forest) in Johor. Since then, he has held various posts, such as Perlis State Park Manager, Deputy Director of Forest Management, and Director of International Affairs. He currently serves as the Director of the Silviculture and Forest Biology Conservation Division. His expertise includes forest management, taxonomy, climate change, and forest biodiversity.')">
        <img src="{{ asset('images/talker/ALDRICH.png') }}" alt="Dr. Aldrich Richard" />
