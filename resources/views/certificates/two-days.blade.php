    ...
    <div class="certificate">
        <div class="content" style="text-align: center; padding: 20mm;gap:0;">
            <div class="logos" style="display: flex; justify-content: center; margin-top: 35mm;">
                <img src="{{ public_path('images/logo-icon.png') }}" alt="Logo" style="width: auto; height: 80px;">
                <img src="{{ public_path('images/logo_mfc-no-bg.png') }}" alt="Logo" style="width: auto; height: 90px;">
            </div>
            ...
            <p>has attended the<br><strong>21ˢᵗ Malaysian Forestry Conference 2026M<br><span style="font-style: italic; color: #305f45; line-height: 1.5;">"Forests as Catalyst for a Green Economy"</strong></span></p>
            <p style="color: #4e4e4e;">13-15 July 2026<br>Pullman Hotel, Kuching, Sarawak</p>
