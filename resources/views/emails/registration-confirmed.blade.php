...
<head>
    ...
    <style>
        ...
        .header { background: #908D31; padding: 36px 32px; text-align: center; }
        ...
        .body { padding: 32px; }
        .body h2 { color: #908D31; font-size: 20px; margin-bottom: 10px; }
        ...
        .details td:first-child { font-weight: 600; color: #908D31; width: 40%; }
